            ...
            <div className="flex gap-6 items-center">
                {session ? (
                    <>
                        ...
                        {!session.user?.isPro && (
                            <Link href="/pricing" className="bg-gradient-to-r from-yellow-400 to-orange-500 text-white px-3 py-1 rounded-full text-sm font-bold hover:shadow-md transition-shadow flex items-center gap-1">
